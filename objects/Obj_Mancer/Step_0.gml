...
if(steps % 8 = 0){
	repeat(2){
		scr_ParticleGeneration(x - 2 + round(random(4)),y - 4,1,90,30,0.6,#5B315B,#5B315B,#5B315B,1,false);
	}
}
// light particles are made every frame
scr_ParticleGeneration(x - 1 + round(random(2)),y - 4,1,90,30,0.3,#E60000,#E60000,#E60000,1,true);
