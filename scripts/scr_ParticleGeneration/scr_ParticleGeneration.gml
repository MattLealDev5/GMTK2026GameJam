...
// Script assets have changed for v2.3.0 see
// https://help.yoyogames.com/hc/en-us/articles/360005277377 for more information
function scr_ParticleGenerationChaser(X,Y,LAYER,SPEED,DIRECTION,SPREAD,SCALE,COLOR1,COLOR2,COLOR3,AMOUNT,INSTANT){
	...
	randomise();
	repeat(AMOUNT){
		with(instance_create_layer(X,Y,LAYER,obj_particleChaser)){
			speed = SPEED* (0.8 + random(0.4));
			direction = DIRECTION;
